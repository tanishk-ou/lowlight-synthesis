...
**Model Repository**: See [tanishkgopalani/lowlight-multitask-unet](https://github.com/tanishkgopalani/lowlight-multitask-unet) for the encoder implementation and training code.
...
@misc{gopalani2026lowlight,
  ...
  url={https://github.com/tanishkgopalani/lowlight-synthesis}
}
```
