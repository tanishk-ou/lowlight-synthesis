...
"""Image signal processing (ISP) pipeline: raw Bayer to sRGB.

This module implements the standard ISP pipeline for processing raw Bayer
sensor data into sRGB images, which is the inverse of the unprocess.py module.

Pipeline steps:
1. apply_gains: White balance gain adjustment
2. demosaic: Convert Bayer pattern to full RGB using bilinear interpolation
3. apply_ccms: Color correction matrix application
4. gamma_compression: Gamma compression to sRGB (gamma=2.2)

The module supports:
- Batch processing (multiple images at once)
- Linear RGB intermediate output (for local processing)
- Full sRGB output with gamma compression
...
# You can keep the original process function for other uses or remove it
